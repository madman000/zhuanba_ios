...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        // Initialization code
        self.borderColor =TomColor(0x666666);
...
-(CGRect)getViewFrame
{
    ...
    if ([self.titleArray count] == [self.imageArray count]) {
        frame.size.width = 10 + 25 + 10 + frame.size.width ;
    }else{
        frame.size.width = 10 + frame.size.width;
    }
...
//
    ...
    UIView *cellline = [[UIView alloc]initWithFrame:CGRectMake(10, cell.frame.size.height, cell.frame.size.width-30,.5)];
    cellline.backgroundColor = [UIColor grayColor];
    [cell addSubview:cellline];
    cell.backgroundView = [[UIView alloc] init];
    cell.backgroundView.backgroundColor =TomColor(0x333333);
